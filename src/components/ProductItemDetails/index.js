...
class ProductItemDetails extends Component {
  ...
  renderLoadingView = () => (
    <div className="product-details-loader-cotainer" data-testid="loader">
  ...
  renderProductDetailsView = () => {
    const {productData, quantity, similarProductData} = this.setState
    const {
      availabilty,
      brand,
      description,
        ...
        <div className="product-details-container">
          ...
          <div className="product">
            ...
            <div className="label-value-container">
              ...
              <p className="value">{availabilty}</p>
            </div>
            <div className="label-value-container">
